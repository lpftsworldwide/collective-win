...
INSERT INTO public.licensed_games (
  ...
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'gates-of-olympus', 'Gates of Olympus', 'slots', 96.50, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'sweet-bonanza', 'Sweet Bonanza', 'slots', 96.48, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'starlight-princess', 'Starlight Princess 1000', 'slots', 96.55, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'legend-of-cleopatra', 'Legend of Cleopatra', 'slots', 95.05, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'egypt-fire', 'Egypt Fire (Hold and Win)', 'slots', 96.25, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'golden-pharaoh-megaways', 'Golden Pharaoh Megaways', 'slots', 96.80, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'crystal-fortune-deluxe', 'Crystal Fortune Deluxe', 'slots', 96.50, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'oceans-treasure-quest', 'Ocean''s Treasure Quest', 'slots', 97.10, 'low', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'blackjack-royal-vip', 'Blackjack Royal VIP', 'table', 99.50, 'low', 'active', 1.00, 5000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'dragons-fire-prosperity', 'Dragon''s Fire Prosperity', 'slots', 96.90, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'lightning-strike-roulette', 'Lightning Strike Roulette', 'live', 97.30, 'medium', 'active', 0.50, 5000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'wild-west-bounty-hunter', 'Wild West Bounty Hunter', 'slots', 96.60, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'cosmic-gems-cluster', 'Cosmic Gems Cluster', 'slots', 96.70, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'mega-fortune-jackpot-king', 'Mega Fortune Jackpot King', 'slots', 95.80, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'ancient-aztec-gold', 'Ancient Aztec Gold', 'slots', 96.40, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'baccarat-royale-supreme', 'Baccarat Royale Supreme', 'live', 98.90, 'low', 'active', 1.00, 10000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'neon-city-nights', 'Neon City Nights', 'slots', 96.80, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'viking-conquest-saga', 'Viking Conquest Saga', 'slots', 97.00, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'crash-rocket-multiplier', 'Crash Rocket Multiplier', 'crash', 97.50, 'high', 'active', 0.10, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'diamond-dynasty-deluxe', 'Diamond Dynasty Deluxe', 'slots', 96.50, 'low', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'egyptian-mysteries-unlimited', 'Egyptian Mysteries Unlimited', 'slots', 96.90, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'fruit-blitz-super-spin', 'Fruit Blitz Super Spin', 'slots', 97.20, 'low', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'pirates-plunder-megaways', 'Pirate''s Plunder Megaways', 'slots', 96.60, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'starburst-crystal-classic', 'Starburst Crystal Classic', 'slots', 96.30, 'low', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'buffalo-thunder-lightning', 'Buffalo Thunder Lightning', 'slots', 96.70, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'zeus-power-reels', 'Zeus Power Reels', 'slots', 96.80, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'sugar-rush-candy-blitz', 'Sugar Rush Candy Blitz', 'slots', 96.40, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'moon-princess-trinity', 'Moon Princess Trinity', 'slots', 96.50, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'roulette-pro-european', 'Roulette Pro European', 'table', 97.30, 'low', 'active', 0.50, 5000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'aztec-bonanza-infinity', 'Aztec Bonanza Infinity', 'slots', 96.60, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'mega-moolah-fortune', 'Mega Moolah Fortune', 'slots', 95.90, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'dead-or-alive-outlaw', 'Dead or Alive Outlaw', 'slots', 96.80, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'jammin-jars-cluster-party', 'Jammin'' Jars Cluster Party', 'slots', 96.80, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'book-of-secrets-deluxe', 'Book of Secrets Deluxe', 'slots', 96.50, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'gonzos-quest-megaways', 'Gonzo''s Quest Megaways', 'slots', 96.00, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'bonanza-goldmine-megaways', 'Bonanza Goldmine Megaways', 'slots', 96.40, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'legacy-of-egypt-power', 'Legacy of Egypt Power', 'slots', 96.50, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'immortal-romance-remastered', 'Immortal Romance Remastered', 'slots', 96.90, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'fire-joker-respin', 'Fire Joker Respin', 'slots', 96.20, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'reactoonz-quantum-leap', 'Reactoonz Quantum Leap', 'slots', 96.50, 'high', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'street-racer-nitro', 'Street Racer Nitro', 'slots', 96.60, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'tiki-fortune-totem', 'Tiki Fortune Totem', 'slots', 96.30, 'low', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'tomb-raider-expedition', 'Tomb Raider Expedition', 'slots', 96.70, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'space-invaders-arcade', 'Space Invaders Arcade', 'slots', 96.10, 'low', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'rainbow-riches-megaways', 'Rainbow Riches Megaways', 'slots', 96.50, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'wolf-gold-moon-spin', 'Wolf Gold Moon Spin', 'slots', 96.00, 'medium', 'active', 0.20, 1000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'poker-face-texas-holdem', 'Poker Face Texas Hold''em', 'table', 99.00, 'medium', 'active', 1.00, 5000.00, false),
  ((SELECT id FROM public.game_providers WHERE code = 'collective-wins'), 'jungle-adventure-expedition', 'Jungle Adventure Expedition', 'slots', 96.40, 'high', 'active', 0.20, 1000.00, false),
